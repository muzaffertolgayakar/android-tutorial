...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.recyView.setAdapter(artAdapter);
        getData();

    }
    private void getData(){
        try{
            SQLiteDatabase data = this.openOrCreateDatabase("Arts", MODE_PRIVATE, null);
            Cursor cursor = data.rawQuery("SELECT * FROM arts", null);
